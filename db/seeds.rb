...
# User::Manager::FactoryManager.create(name: 'aadesh', age: 31, factory_id: factory.id)
# User::Manager::SalesManager.create(name: 'piyush', age: 21, factory_id: factory.id)
# User::Manager::InventoryManager.create(name: 'ankush', age: 14, factory_id: factory.id)
# user = User::Buyer::Customer.new(name:'maanav',age:21)
# user.factory = factory
# user.save
# User::Buyer::Shopkeeper.create(name: 'karan', age: 27, factory_id: factory.id)
# User::Buyer::Vendor.create(name: 'vikas', age: 47, factory_id: factory.id)
